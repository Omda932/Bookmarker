...
function addUrl(){
  // if(validateUrlName (bookmarkName.value)){
  //   console.log("hiii");
  // }
  if(validateUrl(bookmarkURL.value)){
    sit= {
     ...
     for(var i=0; i<urlContainer.length ; i++){
        trs+= `<tr>
                 <td>${i+1}</td>
                  ...
                  <td>
                    <button class="btn btn-visit" data-index="0" id="vistBtn">
                      <a href="https://${urlContainer[i].url}" target = "_blank" style="text-decoration: none; color: white;"> <i class="fa-solid fa-eye pe-2"></i>Visit</a>
                    </button>
                  </td>
                  <td>
...
//  return bookmarkNameRgex.text(bookmarkName)
